  ...
  return (
    <section ref={ref} className="relative min-h-screen bg-navy-deep text-cream overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 pt-32 md:pt-40 px-8 md:px-14 pb-24 min-h-screen flex flex-col">
        ...
        <div className="max-w-5xl mt-auto">
          ...
          <div className="mt-10 md:mt-12 grid md:grid-cols-3 gap-8 md:gap-10 items-start">
            ...
            >
              <a href="#programare" aria-label="Programare din secțiunea principală" className="group inline-flex items-center gap-6 bg-cream text-navy rounded-full px-8 py-3.5 hover:bg-gold transition-colors duration-500">
              ...
              <a href={siteConfig.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="Contactați-ne pe WhatsApp din secțiunea principală" className="group inline-flex items-center gap-6 border border-cream/30 rounded-full text-cream px-8 py-3.5 hover:border-gold hover:text-gold transition">
      ...
      <div className="absolute bottom-8 right-8 md:right-14 z-10 text-right">
        ...
        <p className="eyebrow text-cream/70">{clinic.address}</p>
      </div>
    </section>
  );
}
