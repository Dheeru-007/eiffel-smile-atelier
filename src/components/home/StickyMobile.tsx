...
export function StickyMobile() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-navy-deep text-cream grid grid-cols-3 border-t border-cream/15">
      ...
      <a href={siteConfig.whatsapp || "#programare"} target={siteConfig.whatsapp ? "_blank" : undefined} rel="noopener noreferrer" className="py-4 text-center border-r border-cream/15 flex flex-col items-center gap-1">
        <span className="text-lg">💬</span>
