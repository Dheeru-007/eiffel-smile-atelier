    ...
    <footer className="bg-navy-deep text-cream/70 py-20 px-8 md:px-14">
      <div className="grid md:grid-cols-12 gap-8 border-b border-cream/15 pb-12">
        ...
        <div className="md:col-span-3 text-sm">
          <div className="eyebrow text-cream/70 mb-3">Urmărește</div>
          <div className="space-y-2 font-serif text-lg">
            ...
            <a href={siteConfig.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="Contactați-ne pe WhatsApp din subsol" className="block hover:text-gold transition">WhatsApp ↗</a>
          </div>
        </div>
      </div>
      <div className="flex justify-between mt-8 text-xs text-cream/70">
